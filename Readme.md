...
После создания индексов время выполнения запроса уменьшилось
примерно с 72 ms до 0.78 ms. Однако таблицы содержат очень небольшое количество данных. На больших объёмах данных индексы позволят значительно ускорить JOIN и фильтрацию.
